    ...
    public partial class frmbuscarPelicula : Form
    {
        ...
        private void bbuscarPelicula_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                buscarPelicula.Columns.Add("Link Video", typeof(string));
                buscarPelicula.Columns.Add("Fecha Inicio Pelicula", typeof(DateTime));
                buscarPelicula.Columns.Add("Fecha Final Pelicula", typeof(DateTime));
                ...
                while (reader.Read())
                {
                    ...
                    slink = reader.GetString(11).ToString();
                    sfechainicio = reader.GetString(12).ToString();
                    sfechafinal = reader.GetString(13).ToString();


                    
                    // se agregan cada columna al datagrid
                    buscarPelicula.Rows.Add(sidPelicula,stitulo,scosto,sdescuento,ssala,sclasificacion,scategoria,selenco,sidioma,ssubtitulo,spuntos,slink,sfechainicio,sfechafinal);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pelicula.txtlinkVideoPeli.Text = this.grdinformacionPelicula.CurrentRow.Cells[11].Value.ToString();


            String fechaI = Convert.ToString(this.grdinformacionPelicula.CurrentRow.Cells[12].Value);
            pelicula.dtpfechaInicio.Text = fechaI;


            String fechaF = Convert.ToString(this.grdinformacionPelicula.CurrentRow.Cells[13].Value);
            pelicula.dtpfechaFinal.Text = fechaF;
